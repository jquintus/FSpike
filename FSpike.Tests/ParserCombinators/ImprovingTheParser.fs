...
module Section_3  =
    // =============================================
    // Section 3 - Adding position and context to error messages
    // =============================================
    open StartingPoint
    open Section_1
    open Section_2
...
module Test =
    ...
    let tests = Seq.concat [
                    ...
                    Seq.ofList Section_4.testCases
                    Seq.ofList Section_5.testCases
    ]

    [<Tests>] let parserTests = testList "Improving the parser" tests
